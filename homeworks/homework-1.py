# A "heinous" example of arithemtic math problem is the following"
print((5*4*3*2*1)/(3*2*1)*5-12(10-9)/2+1)
# The answer should be 95
# Seemingly simple arithemtic problem requires PEMDAS
...
# cd introduction-to-python/homeworks (This pathway takes me to the directory (homeworks).)
# do nano "homework-1.py" (create python file and it is named homework-1.py)
# Insert comments/print, save the file, and close it to return to the command line
# python3 homework-1.py (this runs the python file.)
